...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">{{ __('View Attributes') }}</div>

                <div class="card-body">

                    <div class="text-right">
                        <a href="{{route('createAttribute')}}">
                        ...
                        <table class="table align-items-center table-flush text-center"  id="datatable-basic">
                            <thead class="thead-light">
                                <tr>                                   
                                    ...
                                    <th scope="col">{{ __(' Model Type Name') }}</th>
                            ...
                            <tbody>
                                @foreach ($options as $option)
                                    <tr>         
                                        ...
                                        <input type="hidden" name="order" class="order" value="{{$option->order}}" />                                         
            ...
            <form action="" method="post" id="edit_form" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="order1" type="text" class="form-control order @error('order') is-invalid @enderror" name="order" value="{{ old('order') }}" autocomplete="order" autofocus>
...
<script>
    $(document).ready(function(){
        $(document).on('click', '.modal-btn2', function (){
            ...
            let order = $(this).parents('tr').find('.order').val().trim();           

            $("#edit_form .id").val(id);
            $("#edit_form .name").val(name);   
            $("#edit_form .order").val(order);                  
            $("#editModal").modal();
        });
